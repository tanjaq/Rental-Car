...
describe('calculatePrice - integration', () => {
  ...
  test('30 y/o, 3 days, low season, license 2.5 years → no inexperienced surcharges', () => {
    // 30 * 3 = 90 (license >= 2 and low season)
