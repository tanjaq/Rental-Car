...
describe('Rental price calculator', () => {
  describe('Current business requirements', () => {
    ...
    test('drivers under 18 cannot rent', () => {
      expect(price('A', 'B', '2024-02-12', '2024-02-12', 'Compact', 17)).toBe(
    ...
    test('drivers aged 18-21 can only rent Compact', () => {
      ...
      expect(price('A', 'B', '2024-02-12', '2024-02-12', 'Electric', 21)).toBe(
    ...
    test('minimum daily price equals driver age', () => {
      expect(price('A', 'B', '2024-02-12', '2024-02-12', 'Compact', 37)).toBe('$37');
      expect(price('A', 'B', '2024-02-12', '2024-02-14', 'Compact', 37)).toBe('$111');
    });
  });
